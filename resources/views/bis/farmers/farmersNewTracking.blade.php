    ...
    <div class="ibox float-e-margins">
          ...
          <div class="col-md-4">
            <div class="form-group" id="data_2">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" class="form-control rangePicker" name="year"  value="" required>
                </div>
            </div>
          </div>
                ...
                <tbody>
                  ...
                  @foreach($income as $keyVal)
                    <tr>
                     ...
                     <td data-link="/bis/income-item/update/income_item" data-id="{{ $keyVal->income_item_id }}" class="wyred-editable"><input type="hidden" value="{{ $keyVal->income_item }}" class="wyred-next" name="income_item[]">{{ $keyVal->income_item }}</td>
                     <td>
                      <div class="form-group">
                ...
                <tbody>
                  <tr>
                    ...
                    <tr>
                     ...
                     <td data-link="/bis/expenses-item/update/expenses_item" data-id="{{ $keyVal->expenses_item_id }}" class="wyred-editable"><input type="hidden" value="{{ $keyVal->expenses_item }}" name="expenses_item[]">{{ $keyVal->expenses_item }}</td>
                     <td>
                      <div class="form-group">
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                        <div class="form-group">
                          ...
                          <input class="input-sm" type="checkbox" name="parents{{ $keyVal->interest_id }}"  data-display="competency_name" >        
                        </div>
                    </td>
                     <td class="text-center">
                        <div class="form-group">
                          <input type="hidden" name="relative{{ $keyVal->interest_id }}" >
                          <input class="input-sm" type="checkbox"  name="relative{{ $keyVal->interest_id }}"  data-display="competency_name" >        
                        </div>
                    </td>
                     <td class="text-center">
                        <div class="form-group">
                          <input type="hidden" name="traders{{ $keyVal->interest_id }}" >
                          <input class="input-sm" type="checkbox"  name="traders{{ $keyVal->interest_id }}"  data-display="competency_name" >        
                        </div>
                    </td>
                     <td class="text-center">
                        <div class="form-group">
                          <input type="hidden" name="diocese{{ $keyVal->interest_id }}" >
                          <input class="input-sm" type="checkbox"  name="diocese{{ $keyVal->interest_id }}"  data-display="competency_name" >        
                        </div>
                    </td>
                     <td class="text-center">
                        <div class="form-group">
                          <input type="hidden" name="silingan{{ $keyVal->interest_id }}" >
                          <input class="input-sm" type="checkbox"  name="silingan{{ $keyVal->interest_id }}"  data-display="competency_name" >        
                        </div>
                    </td>
                    <td class="text-center">
                        <div class="form-group">
                          <input type="hidden" name="govt{{ $keyVal->interest_id }}" >
                          <input class="input-sm" type="checkbox"  name="govt{{ $keyVal->interest_id }}"  data-display="competency_name" >        
                        </div>
                    </td>
                     <td class="text-center">
                        <div class="form-group">
                          <input type="hidden" name="po{{ $keyVal->interest_id }}" >
                          <input class="input-sm" type="checkbox"  name="po{{ $keyVal->interest_id }}"  data-display="competency_name" >        
                        </div>
                    </td>
                     <td class="text-center">
                        <div class="form-group">
                          <input type="hidden" name="fo{{ $keyVal->interest_id }}" >
                          <input class="input-sm" type="checkbox" name="fo{{ $keyVal->interest_id }}"  data-display="competency_name" >        
                        </div>
                    </td>
                    <td class="text-center">
                        <div class="form-group">
                          <input type="hidden" name="micro_finance{{ $keyVal->interest_id }}" >
                          <input class="input-sm" type="checkbox"  name="micro_finance{{ $keyVal->interest_id }}"  data-display="competency_name" >        
                        </div>
                    </td>
                    </tr>
                  @endforeach
            ...
            <table id="" class="table table-striped table-hover table-bordered dataTables-example" role="grid" aria-describedby="example2_info">
                ...
                <tbody>
                  ...
                  <tr class="landTenure">
                    <td>
                        <div class="form-group">
                          <input class="form-control input-sm" type="text" id="land_name" name="land_name[]"  data-display="competency_name" required>        
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                          <input class="form-control input-sm" type="text" id="land_size" name="land_size[]"  data-display="competency_name" required>        
                        </div>
                    </td>
                    <td>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <td>
                        <div class="form-group">
                          <input class="form-control input-sm" type="text" id="ownership" name="ownership[]"  data-display="competency_name" required>        
                        </div>
                    </td>
                     <td class="text-center">
            ...
            <table id="" class="table table-striped table-hover table-bordered dataTables-example" role="grid" aria-describedby="example2_info">
                ...
                <tbody>
                  ...
                  <tr class="agriTr">
                    <td>
                        <div class="form-group">
                          <input class="form-control input-sm" type="text" id="tk_name" name="tk_name[]"  data-display="competency_name" required>        
                        </div>
                    </td>
                    <td>
                    <div class="form-group">
                      <select class="form-control input-sm" name="agri_type[]" id="agri_type" required>
                        <option></option>
                        @foreach($agri_type as $agri_type)
                        <option value="{{$agri_type->type_id}}">{{$agri_type->type_name}}</option>
                        @endforeach
                      </select>      
                    </div>
                    </td>
                    ...
                    <div class="form-group">
                      <select class="form-control input-sm" name="agri_status[]" id="agri_status" required>
                        <option></option>
                        @foreach($agri_status as $agri_status)
                        <option value="{{$agri_status->status_id}}">{{$agri_status->status}}</option>
                        @endforeach
                      </select>      
                    </div>
                    </td>
                     <td>
                      ...
                      <select class="form-control input-sm" name="techApply[]" id="techApply" required>
                        <option></option>
                        @foreach($techApply as $techApply)
                        <option value="{{$techApply->technology_apply_id}}">{{$techApply->technology_apply}}</option>
                        @endforeach
                      </select>      
                    </div>
                    </td>
                    <td>
                         <div class="form-group">
                          <input class="form-control input-sm" type="text" id="input_used" name="input_used[]"  data-display="competency_name" required>        
                        </div>
                    </td>
                    <td class="text-center">
      ...
      <div class="col-md-12">
        ...
        <div class="form-group">
          ...
          <span class="pull-right"><button class="btn btn-primary ladda ladda-button" data-url="/bis/save-new-tracking" id="ladda" data-size="s" data-style="expand-left"><span class="ladda-label" id="saveBtn">Save</span></button> </span>
        </div>
        <div class="hr-line-dashed"></div>
        </div>
