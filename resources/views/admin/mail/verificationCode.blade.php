      ...
      <table>
        <tr>
          <td>
            ...
            <!-- button -->
            <div style="background-color:rgba(247, 247, 247, 0.91);height:auto;text-align: center;">
                <h2 style="text-transform:uppercase;color:grey;">{{$vcode}}</h2>
            </div>
            <!-- /button -->
            <bR>
            <br>
            <p>Enter this Verification code to reset your password.</p>
            <p>*Note that this Verification code will only be available on one day upon request.</p>
